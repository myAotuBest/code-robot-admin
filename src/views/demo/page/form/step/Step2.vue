 ...
 * @LastEditors: Roy
 * @LastEditTime: 2021-07-14 18:27:16
 * @Deprecated: 否
 * @FilePath: /vue-antd-admin/src/views/demo/page/form/step/Step2.vue
-->
<template>
  <div class="step2">
    ...
    <a-descriptions :column="1" class="mt-5">
      ...
      <a-descriptions-item label="收款人姓名"> Roy </a-descriptions-item>
