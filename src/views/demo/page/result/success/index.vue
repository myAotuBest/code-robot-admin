 ...
 * @LastEditors: Roy
 * @LastEditTime: 2021-07-14 18:26:26
 * @Deprecated: 否
 * @FilePath: /vue-antd-admin/src/views/demo/page/result/success/index.vue
-->
<template>
  <div class="m-5 result-success">
    ...
    <div class="result-success__content">
      <Descriptions title="项目名称">
        ...
        <DescriptionItem label="负责人"> Roy </DescriptionItem>
        <DescriptionItem label="生效时间"> 2016-12-12 ~ 2017-12-12 </DescriptionItem>
      </Descriptions>
      <Steps :current="1" progress-dot size="small">
        <Step title="创建项目">
          <template #description> <div>Roy</div> <p>2016-12-12 12:32</p> </template>
        </Step>
        <Step title="部门初审">
